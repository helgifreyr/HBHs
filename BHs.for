...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
     ...
     -       (-2.*ff**3*g*H*r*sn*U1x + 
     -         ff**2*H*sn*
     -          (-1.*g*U2x + r**2*(U1x + U2x -U3x)) + 
     -         ff**4*g*H*r*sn*
     -          (U1xx - U2x*U3x + 2.*alpha**2*U4x**2) + 
     -         r*(-cs*U3y + 
     -            sn*(U1yy - U2y*U3y + 2.*alpha**2*U4y**2)))
     -       -dExp(4.*U2)*g**2*sn**4*
     ...
     -     (nr*U5 + w)**2)/(dExp(2.*U3)*g*H**2*r)  
      ...
      eq4=        (-dExp(2.*U1 - 2.*U2)*H*nr**2*U4 - 
     -    1.*dExp(2.*U1)*c3*g*H*sn**2*U4 + 
     ...
     -       (nr*U5 + w)**2)/r**2)/H**2 
      ...
      eq5= (r*(dExp(2.*U2)*sn*
     -       (-2.*ff**3*g*H*r*sn*U5x - 
     -         ff**2*H*(g - 5.*r**2)*sn*U5x + 
     -         ff**4*g*H*r*sn*(3.*U2x*U5x -U3x*U5x + U5xx) + 
     -         r*(3.*cs*U5y + 
...
cccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &
       ...
       Vy21=0.
       V21=
     & (4.*dExp(2.*U1 - 2.*U2)*alpha**2*
     &     (2.*nr**2 + dExp(2.*U2)*c3*g*sn**2)*U4**2)/
     &   (g*H)
     &
       Vxx22=ff**4*sn**2
       Vxy22=0.
     ...
     & (2.*dExp(2.*U1)*U4*
     &     ((-1.*H*nr**2)/dExp(2.*U2) - 
     &       1.*c3*g*H*sn**2 + (g**2*sn**2*(nr*U5 + w)**2)/
     &        (dExp(2.*U3)*r**2)))/H**2
     &
       Vxx42=0.
       Vxy42=0.
