...
c UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU       
	...
	DOUBLE PRECISION   eta,nr,w,con,alpha,c1,c2,c3,lambda,
     & x,y,k1,k2,k3,k4,fi1,fi2,a1,r,s,rh,par 
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
      ...
      eq1=(0.25*(2.*dExp(2.*(U2 + U3))*derH*ff**2*g*
     -    H*r**2*sn**2*(U1x - 1.*U2x) - 
     -      8.*dExp(2.*(U1 + U3))*alpha**2*H*
     -       nr**2*r**2*U4**2 + 
     -      4.*dExp(2.*(U2 + U3))*H*r*sn*
     -       (-2.*ff**3*g*H*r*sn*U1x + 
     -         ff**2*H*sn*
     ...
     -       - 1.*dExp(4.*U2)*g**2*sn**4*
     -       (ff**4*g*H*U5x**2 + U5y**2) + 
     -      8.*dExp(2.*(U1 + U2))*alpha**2*g**2*
     -       sn**2*U4**2*(nr*U5 + w)**2))/
     -  (dExp(2.*(U2 + U3))*g*H**2*r)

      eq2=  (0.5*(2.*dExp(2.*(U2 + U3))*H*r*sn*
     -       (-2.*ff**3*g*H*r*sn*U2x + 
     -         ff**4*g*H*r*sn*(U2x**2 + U2xx + U2x*U3x) + 
     -         ff**2*sn*(g*(H + derH*r)*U2x + 
     -            H*r**2*(2.*U2x + U3x)) + 
     -         r*(cs*(2.*U2y + U3y) + 
     -            sn*(U2y**2 + U2yy + U2y*U3y))) + 
     -      8.*dExp(2.*(U1 + U3))*alpha**2*H*
     -       nr**2*r**2*U4**2 + 
     -      4.*dExp(2.*(U1 + U2 + U3))*alpha**2*g*
     -       H*r**2*sn**2*U4**2*(c3 + c2*U4**2) + 
     -      dExp(4.*U2)*g**2*sn**4*
     -       (ff**4*g*H*U5x**2 + U5y**2)))/
     -  (dExp(2.*(U2 + U3))*g*H**2*r**2) 
     ...
     -        + 2.*ff**4*g*H*r*sn*(U2x*U3x + U3x**2 + U3xx) + 
     -       2.*r*(cs*U3y + sn*(U2y*U3y + U3y**2 + U3yy))) + 
     -    4.*dExp(2.*(U1 + U3))*alpha**2*g*H*r**2*
     -     sn*U4**2*(c3 + c2*U4**2) - 
     -    1.*dExp(2.*U2)*g**2*sn**3*
     -     (ff**4*g*H*U5x**2 + U5y**2) - 
     -    8.*dExp(2.*U1)*alpha**2*g**2*sn*U4**2*
     -     (nr*U5 + w)**2)/(dExp(2.*U3)*g*H**2*r)     
     

      eq4=  (-1.*dExp(2.*U1 - 2.*U2)*H*nr**2*U4 - 
     -    1.*dExp(2.*U1)*g*H*sn**2*U4*
     -     (c3 + 2.*c2*U4**2) + 
     -    (H*sn*(-2.*ff**3*g*H*r*sn*U4x + 
     -         ff**2*(H*r**2 + g*(H + derH*r))*sn*U4x + 
     -         ff**4*g*H*r*sn*(U2x*U4x + U3x*U4x + U4xx) + 
     -         r*(cs*U4y + sn*(U2y*U4y + U3y*U4y + U4yy))))/r + 
     ...
     -       (nr*U5 + w)**2)/r**2)/H**2   
      ...
      eq5= (r*(dExp(2.*U2)*sn*
     -       (-2.*ff**3*g*H*r*sn*U5x - 
     -         1.*ff**2*H*(g - 5.*r**2)*sn*U5x + 
     -         ff**4*g*H*r*sn*(3.*U2x*U5x - 1.*U3x*U5x + U5xx) + 
     -         r*(3.*cs*U5y + 
     -            sn*(3.*U2y*U5y - 1.*U3y*U5y + U5yy))) - 
     -      8.*dExp(2.*U1)*alpha**2*nr*r*U4**2*
     -       (nr*U5 + w)))/(dExp(2.*U2)*g*H)   
...
c      	write(6,*)r,U4,max
       ...
       T44=  -(c3*U4**2) - (csc**2*nr**2*U4**2)/(dExp(2*U2)*g) - 
     -  c2*U4**4 - (ff**4*H*U4x**2)/dExp(2*U1) - 
     -  U4y**2/(dExp(2*U1)*g) + 
     -  (g*nr**2*U4**2*U5**2)/(dExp(2*U3)*H*r**2) - 
     -  (g*U4**2*w**2)/(dExp(2*U3)*H*r**2)

c Ttot= 2Td[4, 4] - Sum[Td[i, i]]
         
	   Ttot=  (2*U4**2*(c3*dExp(2*U3)*H*r**2 + 
     -      c2*dExp(2*U3)*H*r**2*U4**2 - 2*g*w*(nr*U5 + w)))/
     -  (dExp(2*U3)*H*r**2)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       Vy11=0.
       V11=
     & (4.*dExp(2.*U1 - 2.*U2 - 2.*U3)*alpha**2*U4**2*
     ...
     &
       ...
       V12=
     & (0.5*(8.*dExp(2.*(U1 + U3))*alpha**2*H*nr**2*
     &        r**2*U4**2 - 1.*dExp(4.*U2)*g**2*sn**4*
     &        (ff**4*g*H*U5x**2 + U5y**2)))/
     &   (dExp(2.*(U2 + U3))*g*H**2*r)
     &
       Vxx13=0.
     ...
     &        (c3 + 2.*c2*U4**2) - 
     &       1.*dExp(2.*U2)*g**2*sn**2*(nr*U5 + w)**2)
     &)/(H**2*r**2)
     &
       Vxx42=0.
       Vxy42=0.
