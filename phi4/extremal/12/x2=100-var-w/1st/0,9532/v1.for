...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
     ...
     -            H*r**2*(U1x + U2x - 1.*U3x)) + 
     -         ff**4*g*H*r**2*sn*
     -          (U1xx - 1.*U2x*U3x + 2.*U4x**2) + 
     -         H**3*(-1.*cs*U3y + 
     -            sn*(U1yy - 1.*U2y*U3y + 2.*U4y**2))) - 
     -      1.*dExp(4.*U2)*H**3*sn**4*
     -       (r**2*(-2.*r*U5 + ff**2*g*U5x)**2 + g*H**2*U5y**2)
     -       + 8.*dExp(2.*(U1 + U2))*g*H**5*sn**2*
     -       U4**2*(nr*U5 + g*w)**2))/
     ...
     -      4.*dExp(2.*(U1 + U3))*g**2*H**4*r**4*
     -       sn*U4**2*(1. + c2*U4**2) + 
     -      dExp(2.*U2)*H**4*sn**3*
     -       (r**2*(-2.*r*U5 + ff**2*g*U5x)**2 + g*H**2*U5y**2)
     -       + 8.*dExp(2.*U1)*g*H**6*sn*U4**2*
     -       (nr*U5 + g*w)**2))/
...
c       	write(6,*)r,eq5 
       ...
       T34= (-2*g*H**2*nr*U4**2*(nr*U5 + w))/(dExp(2*U3)*r**4) 
	   
 
       T44=  -1.*c2*U4**4 - (1.*(ff**4*g*r**2*U4x**2 + H**2*U4y**2))/
     -   (dExp(2.*U1)*g*H**2) + 
     -  U4**2*(-1. - (1.*csc**2*nr**2)/
     -      (dExp(2.*U2)*g) - 
...
c Ttot= 2Td[4, 4] - Sum[Td[i, i]]
	 ...
	 Ttot= (2.*U4**2*(dExp(2.*U3)*r**4*
     -       (1. + c2*U4**2) - 2.*H**2*w*(nr*U5 + g*w)))/
     -  (dExp(2.*U3)*r**4) 
...
cccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &
       ...
       V12=
     & (0.5*H**2*(8.*dExp(2.*U1)*g*nr**2*U4**2 - 
     &       (1.*dExp(4.*U2 - 2.*U3)*sn**4*
     ...
     &
       ...
       Vxy14=0.
       Vyy14=0.
       Vx14=4.*ff**4*r**2*sn**2*U4x
       Vy14=(4.*H**2*sn**2*U4y)/g
       V14=
     & (4.*dExp(2.*U1)*H**2*U4*
     &     ((-1.*nr**2)/dExp(2.*U2) + 
     &       (H**2*sn**2*(nr*U5 + g*w)**2)/
     ...
     &
       ...
       Vy31=0.
       V31=
     & 4.*dExp(2.*U1)*H**2*sn**2*U4**2*
     &   (1. + c2*U4**2 - (2.*g*H**2*((nr*U5)/g + w)**2)/
     &      (dExp(2.*U3)*r**4))
     &
       Vxx32=0.
       Vxy32=0.
     ...
     &
       ...
       Vy34=0.
       V34=
     & (4.*dExp(2.*U1 - 2.*U3)*H**2*sn**2*U4*
     &     (dExp(2.*U3)*g*r**4*(1. + 2.*c2*U4**2) - 
     &       2.*H**2*(nr*U5 + g*w)**2))/(g*r**4)
     &
       Vxx35=0.
       Vxy35=0.
       Vyy35=0.
