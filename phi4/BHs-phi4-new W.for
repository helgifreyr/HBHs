...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
      ...
      eq1=(0.25*(2.*dExp(2.*(U2 + U3))*derH*ff**2*
     -       g**2*H*r**2*sn**2*(U1x - 1.*U2x) - 
     -      8.*dExp(2.*(U1 + U3))*alpha**2*g*H*
     -       nr**2*r**2*U4**2 + 
     -      4.*dExp(2.*(U2 + U3))*g*H*r*sn*
     -       (-2.*ff**3*g*H*r*sn*U1x + 
     -         ff**2*H*sn*
     -          (-1.*g*U2x + r**2*(U1x + U2x - 1.*U3x)) + 
     -         ff**4*g*H*r*sn*
     -          (U1xx - 1.*U2x*U3x + 2.*alpha**2*U4x**2) + 
     -         r*(-1.*cs*U3y + 
     -            sn*(U1yy - 1.*U2y*U3y + 2.*alpha**2*U4y**2)))
     -       - 1.*dExp(4.*U2)*sn**4*
     -       (H*(-2.*r*U5 + ff**2*g*U5x)**2 + g*U5y**2) + 
     -      8.*dExp(2.*(U1 + U2))*alpha**2*g*
     -       sn**2*U4**2*(nr*U5 + g*w)**2))/
     -  (dExp(2.*(U2 + U3))*g**2*H**2*r)   

      eq2=  (0.5*(2.*dExp(2.*(U2 + U3))*g*H*r*sn*
     -       (-2.*ff**3*g*H*r*sn*U2x + 
     -         ff**4*g*H*r*sn*(U2xx + U2x*(U2x + U3x)) + 
     -         ff**2*sn*(g*(H + derH*r)*U2x + 
     -            H*r**2*(2.*U2x + U3x)) + 
     -         r*(cs*(2.*U2y + U3y) + 
     -            sn*(U2yy + U2y*(U2y + U3y)))) + 
     -      8.*dExp(2.*(U1 + U3))*alpha**2*g*H*
     ...
     -       g**2*H*r**2*sn**2*U4**2*(c3 + c2*U4**2) + 
     -      dExp(4.*U2)*sn**4*
     -       (H*(-2.*r*U5 + ff**2*g*U5x)**2 + g*U5y**2)))/
     -  (dExp(2.*(U2 + U3))*g**2*H**2*r**2)  


      eq3=  (dExp(2.*U3)*g*H*r*
     -     (-4.*ff**3*g*H*r*sn*U3x + 
     -       ff**2*sn*(-2.*H*r**2*U2x + 
     -          g*(2.*H*(U2x + 2.*U3x) + derH*r*(U2x + 3.*U3x)))
     -        + 2.*ff**4*g*H*r*sn*(U3x*(U2x + U3x) + U3xx) + 
     -       2.*r*(cs*U3y + sn*(U3y*(U2y + U3y) + U3yy))) + 
     -    4.*dExp(2.*(U1 + U3))*alpha**2*g**2*H*
     -     r**2*sn*U4**2*(c3 + c2*U4**2) - 
     -    1.*dExp(2.*U2)*sn**3*
     -     (H*(-2.*r*U5 + ff**2*g*U5x)**2 + g*U5y**2) - 
     -    8.*dExp(2.*U1)*alpha**2*g*sn*U4**2*
     -     (nr*U5 + g*w)**2)/
     -  (dExp(2.*U3)*g**2*H**2*r) 
     

      eq4= (-1.*dExp(2.*(U1 + U3))*H*nr**2*r**2*U4 - 
     -    1.*dExp(2.*(U1 + U2 + U3))*g*H*r**2*
     -     sn**2*U4*(c3 + 2.*c2*U4**2) + 
     -    dExp(2.*(U2 + U3))*H*r*sn*
     -     (-2.*ff**3*g*H*r*sn*U4x + 
     -       ff**2*(g*H + derH*g*r + H*r**2)*sn*U4x + 
     -       ff**4*g*H*r*sn*((U2x + U3x)*U4x + U4xx) + 
     -       r*(cs + sn*(U2y + U3y))*U4y + r*sn*U4yy) + 
     -    dExp(2.*(U1 + U2))*sn**2*U4*
     -     (nr*U5 + g*w)**2)/
     -  (dExp(2.*(U2 + U3))*H**2*r**2)   
 

      eq5= (r*(dExp(2.*U2)*sn*
     -       (H*sn*(-2.*r**3*U5 - 1.*ff**2*g**2*U5x + 
     -            ff**2*g*r**2*(-6.*U2x*U5 + 2.*U3x*U5 + U5x) + 
     -            ff**3*g**2*r*
     -             ((-2. + 3.*ff*U2x - 1.*ff*U3x)*U5x + ff*U5xx))
     -           + g*r*(3.*cs*U5y + 
     -            sn*(3.*U2y*U5y - 1.*U3y*U5y + U5yy))) - 
     -      8.*dExp(2.*U1)*alpha**2*g*nr*r*U4**2*
     -       (nr*U5 + g*w)))/(dExp(2.*U2)*g**2*H)  
...
c      	write(6,*)r,U4,max
       ...
       T34=(-2.*nr*U4**2*(nr*U5 + g*w))/
     & (dExp(2.*U3)*H*r**2)  
	   
 
       T44= -1.*c3*U4**2 - (1.*csc**2*nr**2*U4**2)/
     -   (dExp(2.*U2)*g) - 1.*c2*U4**4 - 
     -  (1.*ff**4*H*U4x**2)/dExp(2.*U1) - 
     -  (1.*U4y**2)/(dExp(2.*U1)*g) + 
     -  (nr**2*U4**2*U5**2)/
     -   (dExp(2.*U3)*g*H*r**2) - 
     -  (1.*g*U4**2*w**2)/(dExp(2.*U3)*H*r**2)  

c Ttot= 2Td[4, 4] - Sum[Td[i, i]]
         
	 
	 Ttot=(2.*U4**2*(dExp(2.*U3)*c3*H*r**2 + 
     -      dExp(2.*U3)*c2*H*r**2*U4**2 - 
     -      2.*w*(nr*U5 + g*w)))/
     -  (dExp(2.*U3)*H*r**2)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccc
       ...
       Vy11=0.
       V11=
     & (-4.*dExp(2.*U1 - 2.*U2 - 2.*U3)*alpha**2*
     &     U4**2*(dExp(2.*U3)*H*nr**2*r**2 - 
     &       1.*dExp(2.*U2)*sn**2*(nr*U5 + g*w)**2))/
     &   (g*H**2*r)
     &
       Vxx12=0.
       Vxy12=0.
     ...
     &
       ...
       V12=
     & (0.5*(8.*dExp(2.*(U1 + U3))*alpha**2*g*H*
     &        nr**2*r**2*U4**2 - 
     &       1.*dExp(4.*U2)*sn**4*
     &        (H*(-2.*r*U5 + ff**2*g*U5x)**2 + g*U5y**2)))/
     &   (dExp(2.*(U2 + U3))*g**2*H**2*r)
     ...
     &
       ...
       V14=
     & (-4.*dExp(2.*U1 - 2.*U2 - 2.*U3)*alpha**2*U4*
     &     (dExp(2.*U3)*H*nr**2*r**2 - 
     &       1.*dExp(2.*U2)*sn**2*(nr*U5 + g*w)**2))/
     &   (g*H**2*r)
     &
       Vxx15=0.
       ...
       Vyy15=0.
       Vx15=
     & (-0.5*dExp(2.*U2 - 2.*U3)*ff**2*sn**4*
     &     (-2.*r*U5 + ff**2*g*U5x))/(g*H*r)
     &
       Vy15=
     & (-0.5*dExp(2.*U2 - 2.*U3)*sn**4*U5y)/(g*H**2*r)
     &
       V15=
     & (sn**2*(-1.*dExp(2.*U2)*H*r*sn**2*
     &        (2.*r*U5 - 1.*ff**2*g*U5x) + 
     &       4.*dExp(2.*U1)*alpha**2*g*nr*U4**2*
     &        (nr*U5 + g*w)))/(dExp(2.*U3)*g**2*H**2*r)
     &
       Vxx21=0.
       Vxy21=0.
       Vyy21=0.
     ...
     &
       ...
       V22=
     & (-8.*dExp(2.*(U1 + U3))*alpha**2*g*H*nr**2*
     &      r**2*U4**2 + dExp(4.*U2)*sn**4*
     &      (H*(-2.*r*U5 + ff**2*g*U5x)**2 + g*U5y**2))/
     &   (dExp(2.*(U2 + U3))*g**2*H**2*r**2)
     &
       Vxx23=0.
     ...
     &
       ...
       Vyy25=0.
       Vx25=
     & (dExp(2.*U2 - 2.*U3)*ff**2*sn**4*
     &     (-2.*r*U5 + ff**2*g*U5x))/(g*H*r**2)
     &
       Vy25=
     & (dExp(2.*U2 - 2.*U3)*sn**4*U5y)/(g*H**2*r**2)
     &
       V25=
     & (-2.*dExp(2.*U2 - 2.*U3)*sn**4*
     &     (-2.*r*U5 + ff**2*g*U5x))/(g**2*H*r)
     &
       Vxx31=0.
       Vxy31=0.
       Vyy31=0.
       ...
       Vy31=0.
       V31=
     & (8.*dExp(2.*U1 - 2.*U3)*alpha**2*sn*U4**2*
     &     (dExp(2.*U3)*c3*g*H*r**2 + 
     &       dExp(2.*U3)*c2*g*H*r**2*U4**2 - 
     &       2.*(nr*U5 + g*w)**2))/(g*H**2*r)
     &
       Vxx32=0.
       Vxy32=0.
       Vyy32=0.
     ...
     &
       Vy32=(2.*r*sn*U3y)/(g*H)
       V32=
     & (-2.*dExp(2.*U2 - 2.*U3)*sn**3*
     &     (H*(-2.*r*U5 + ff**2*g*U5x)**2 + g*U5y**2))/(g**2*H**2*r)
     &
       Vxx33=2.*ff**4*r*sn
       Vxy33=0.
       Vyy33=(2.*r*sn)/(g*H)
     ...
     &
       ...
       Vyy35=0.
       Vx35=
     & (-2.*dExp(2.*U2 - 2.*U3)*ff**2*sn**3*
     &     (-2.*r*U5 + ff**2*g*U5x))/(g*H*r)
     &
       Vy35=
     & (-2.*dExp(2.*U2 - 2.*U3)*sn**3*U5y)/(g*H**2*r)
     &
       V35=
     & (-4.*sn*(dExp(2.*U2)*H*r*sn**2*
     &        (2.*r*U5 - 1.*ff**2*g*U5x) + 
     &       4.*dExp(2.*U1)*alpha**2*g*nr*U4**2*
     &        (nr*U5 + g*w)))/(dExp(2.*U3)*g**2*H**2*r)
     &
       ...
       Vy41=0.
       V41=
     & (-2.*dExp(2.*U1 - 2.*U2 - 2.*U3)*U4*
     &     (dExp(2.*U3)*H*nr**2*r**2 + 
     &       dExp(2.*(U2 + U3))*g*H*r**2*sn**2*
     &        (c3 + 2.*c2*U4**2) - 
     &       1.*dExp(2.*U2)*sn**2*(nr*U5 + g*w)**2))/
     &   (H**2*r**2)
     &
     ...
     &
       ...
       Vx44=
     & (ff**2*sn**2*(H*r**2 + g*
     &        (derH*r + H*(1. - 2.*ff*r + ff**2*r*(U2x + U3x)))))/
     &   (H*r)
     &
     ...
     &
       ...
       Vxy52=0.
       Vyy52=0.
       Vx52=(3.*ff**2*r**2*sn**2*(-2.*r*U5 + ff**2*g*U5x))/g
     ...
     &
       ...
       Vxy53=0.
       Vyy53=0.
       Vx53=(-1.*ff**2*r**2*sn**2*(-2.*r*U5 + ff**2*g*U5x))/g
     ...
     &
       ...
       Vx55=
     & (ff**2*r*sn**2*(r**2 + g*
     &        (-1. - 2.*ff*r + ff**2*r*(3.*U2x - 1.*U3x))))/g
     &
       Vy55=(r**2*sn*(3.*cs + 3.*sn*U2y - 1.*sn*U3y))/(g*H)
       V55=
     & (-2.*r**2*(dExp(2.*U2)*H*r*sn**2*
     &        (r + ff**2*g*(3.*U2x - 1.*U3x)) + 
     &       4.*dExp(2.*U1)*alpha**2*g*nr**2*U4**2))/
     &   (dExp(2.*U2)*g**2*H)
